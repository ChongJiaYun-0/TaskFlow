...
window.showToastMsg = function(message) {
    let toast = document.getElementById('globalToast');
    if (!toast) {
        toast = document.createElement('div');
        toast.id = 'globalToast';
        toast.style.cssText = 'position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:var(--text,#18212f);color:#fff;padding:10px 18px;border-radius:10px;font-size:12px;z-index:999;opacity:0;transition:opacity .25s;pointer-events:none';
...
window.loadTopbar = function(activePage) {
        ...
        <header class="topbar">
            <div class="topbar-left">
                <div>
                    ...
                    <h1 id="pageTitle">${getPageTitle(activePage)}</h1>
                </div>
            </div>
    ...
    document.getElementById('themeToggle')?.addEventListener('click', () => {
        ...
        localStorage.setItem('taskflow-theme', isDark ? 'light' : 'dark');
    });
    ...
    container.innerHTML = `
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="main-nav">
                ...
                <ul class="nav-ul">
                    <li>
                        <button class="nav-item filter-nav ${activePage === 'priority-high' ? 'active' : ''}" data-priority="High" data-page="priority-high" data-href="priority.html?level=High">
                            <span class="dot high"></span>
                            <span class="filter-text">High Priority</span>
                        </button>
                    </li>
                    <li>
                        <button class="nav-item filter-nav ${activePage === 'priority-medium' ? 'active' : ''}" data-priority="Medium" data-page="priority-medium" data-href="priority.html?level=Medium">
                            <span class="dot medium"></span>
                            <span class="filter-text">Medium Priority</span>
                        </button>
                    </li>
                    <li>
                        <button class="nav-item filter-nav ${activePage === 'priority-low' ? 'active' : ''}" data-priority="Low" data-page="priority-low" data-href="priority.html?level=Low">
                            <span class="dot low"></span>
                            <span class="filter-text">Low Priority</span>
                        </button>
                    </li>   
                </ul>
            </nav>
